...
for i=1:num_conics
    start_i = 3*(i-1)+1;
    C1 = Conics(:,start_i:start_i+2);
    for j=i+1:(2*num_conics)
        start_j = 3*(j-1)+1;
        C2 = Conics(:,start_j:start_j+2);
        ...
        if abs(delta) < epsilon
            ...
            if e(1)>0 && e(2)<0
                ...
                % Singular values of A less than 0.001 are treated as zero (tolerance)
                v1 = null(C - e(2)*I, 0.001);
                v2 = null(C - e(1)*I, 0.001);
            ...
            if (dist_o1_plane1*dist_o2_plane1) > 0
                ...
                %plotSurfaceIntersection(Q1, Plane1_paper)
            else 
